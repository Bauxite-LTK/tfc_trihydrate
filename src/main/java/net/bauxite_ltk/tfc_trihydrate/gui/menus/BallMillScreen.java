...
public class BallMillScreen extends IEContainerScreen<BallMillMenu> {
    ...
    protected List<InfoArea> makeInfoAreas()
    {
        return ImmutableList.of(
                new FluidInfoArea(menu.tanks.input(), new Rect2i(leftPos+10, topPos+12, 16, 47),177,31, 20, 51, TEXTURE),
                new FluidInfoArea(menu.tanks.output(), new Rect2i(leftPos+118, topPos+12, 16, 47),177,31, 20, 51, TEXTURE),
