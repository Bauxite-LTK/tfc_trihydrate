...
public class HydrocycloneRecipeSerializer extends IERecipeSerializer<HydrocycloneRecipe> {
    ...
    public ItemStack getIcon() {
        return TFCTHMultiblockLogic.HYDROCYCLONE.iconStack();
    }

    @Override
    public HydrocycloneRecipe readFromJson(ResourceLocation recipeId, JsonObject json, ICondition.IContext context) {
        ...
        return new HydrocycloneRecipe(recipeId, fluidOutput, itemOutput, fluidInput, energy);
    }

    @Override
    public @Nullable HydrocycloneRecipe fromNetwork(ResourceLocation recipeId, FriendlyByteBuf buffer) {
    ...
    @Override
    public void toNetwork(FriendlyByteBuf buffer, HydrocycloneRecipe recipe) {
