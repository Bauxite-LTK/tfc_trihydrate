...
public abstract class TFCTHMultiblockRecipe extends MultiblockRecipe{
    protected <T extends Recipe<?>>
    TFCTHMultiblockRecipe(Lazy<ItemStack> outputDummy, IERecipeTypes.TypeWithClass<T> type, ResourceLocation id)
    {
